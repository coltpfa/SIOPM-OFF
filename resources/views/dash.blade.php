    ...
    <script>
        ...
        document.getElementById('menuForm').addEventListener('submit', function(event) {
            ...
            if (level === 'despachador') {
                ...
                window.location.href = '/usuarios'; // Redireciona para a página do administrador
            } else if (level === 'chefe_operacional') {
                window.location.href = '/chefia'; // Redireciona para a página do chefe operacional
            }
        });
    </script>
@endsection
