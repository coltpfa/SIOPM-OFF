...
ramaisLink.addEventListener("click", function(event) {
    ...
    listaRamais.innerHTML = `
      ...
      <li> 3167 - 3168 - 3166 </li>
      <li class="destaque">Supervisao 193</li>
      <li> 3169 - 3170 </li>
      <li class="destaque">Supervisao Civil</li>
      <li> 3164 - 3165 </li>
      <li class="destaque">SOP 190</li>
      <li> 6550 </li>
     <li class="destaque">SOP Bombeiro</li>
      <li> 6551 </li>
      <li class="destaque">Interprete</li>
      <li> 666 </li>
    `;
...
// Obtém o elemento do botão do tema
var themeButton = document.getElementById("theme-link");

// Adiciona um ouvinte de evento de clique ao botão do tema
themeButton.addEventListener("click", function(event) {
    ...
    // Alterna entre os temas adicionando ou removendo a classe 'dark'
