                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" id="name" placeholder="Nome completo" value="{{ $u->name }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true" name="bpmm" id="bpmm">
                                ...
                                @foreach ($bpmm as $b)
                                    <option value="{{$b->nome}}" @if($u->bpmm == $b->nome) selected @endif>{{$b->nome}}</option>
                                @endforeach
                            </select>
                        </div>
