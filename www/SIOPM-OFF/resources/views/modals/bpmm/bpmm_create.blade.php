                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="radio" name="tipo" class="form-check-input" id="tipo" value="Radio patrulha" >Rádio patrulha<br>
                                <input type="radio" name="tipo" class="form-check-input" id="tipo" value="Especialidades" >Especialidades<br>
